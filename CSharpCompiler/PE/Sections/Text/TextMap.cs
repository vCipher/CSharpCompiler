...
namespace CSharpCompiler.PE.Sections.Text
{
    public sealed class TextMap : IReadOnlyList<DataDirectory>
    {
        ...
        public uint GetVirtualAddressAfter(TextSegment segment)
        {
            var index = (int)segment;
            return _map[index].RVA + _map[index].Size;
        }
        ...
        public uint GetSize()
        {
            ...
            return dir.RVA - TEXT_SECTION_BASE + dir.Size;
        }

        public uint GetOffset(TextSegment begin, TextSegment end)
        {
            return _map[(int)end].RVA - _map[(int)begin].RVA;
        }
        ...
        private uint ComputeVirtualAddress(int index)
        {
            ...
            return prevDirectory.RVA + prevDirectory.Size;
        }
